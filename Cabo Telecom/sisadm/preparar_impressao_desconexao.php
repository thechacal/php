...
<div id="impressao">
<center><b><p>SOLICITA&Ccedil;&Atilde;O DE DESCONEX&Atilde;O</b><p><script language="javascript" src="js/liveclock.js"></script><p>
  </p>
  <table width="428" border="1" cellspacing="0" cellpadding="2">
	...
	<tr>
          ...
          <tr>
            <td width="626" colspan="3">
            <p align="justify"><font face="Verdana" size="2">Declaro para os devidos fins que venho através desta solicitar o cancelamento dos serviços firmados entre minha pessoa e esta empresa, para prestaçăo de serviços de TV por assinatura e/ou Internet, pelo(s) motivo(s) abaixo relacionado(s).
Declaro ainda, ter cięncia que a desconexăo do serviço se cumprirá de acordo com a cláusula trinta e oito, capítulo XII, parágrafo único das condiçőes gerais do contrato.<br><br>
...
<p><input type='image' src='img/imprimir.jpg' title="Imprimir Solicita&ccedil;&atilde;o" onclick="window.open ('impressao_solicitacao_desconexao.php', 'divs', 'width=1000,height=800,scrollbars=yes,resizable=yes');"></p>
</center>
</body>
</html>
