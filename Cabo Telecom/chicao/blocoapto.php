...
?>
   ...
   <HTML> 
<title>Busca pelo Bloco / Apto do Cliente</title>
...
<br>
<b><p>Digite o Bloco / Apto do Cliente:</p></b>
<hr>

<form method="POST" action="search.php">
<p>
    <tr><td>Bloco/Apto: </td></tr>
    <input type=text size=50 name=slap id=slap class=styled onKeyDown="textCounter(this.form.slap,this.form.remLen,44);" onKeyUp="textCounter(this.form.slap,this.form.remLen,44);">
    <input type=hidden size=9 name="tipo" value="slap">
