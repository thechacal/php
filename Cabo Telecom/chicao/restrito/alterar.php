...
$resultado=mysql_query("UPDATE usuarios SET dataalteracao=now(),status='$status',idcabo='$idcabo', nome='$nome', telefone='$telefone', mac='$mac', alteradopor='$PHP_AUTH_USER', slap='$slap'  WHERE id=$id");
