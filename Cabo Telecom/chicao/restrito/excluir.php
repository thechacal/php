...
?>
   ...
   <HTML> 
<title>Excluindo cliente ID Cabo <? echo $idcabo . " ( ". $nome . " )" ;?></title>
...
<b><p>Excluindo cliente: </b> <? echo $idcabo . " ( ". $nome . " )" ;?></p>
<p><b>Sendo excluido pelo usuario: </b><? print_r($PHP_AUTH_USER);?></p>
<FORM name="formcadastro" ACTION="confirmaexclusao.php" METHOD=POST onsubmit="return checkform();">
...
<tr>
<td>Localiza&ccedil;&atilde;o: </td><td><input type=text size=50 name=localizacao id=localizacao value="<?echo $localizacao?>" class=styled onKeyDown="textCounter(this.form.localizacao,this.form.remLen,46);" onKeyUp="textCounter(this.form.localizacao,this.form.remLen,46);"></td>
</tr>

<tr>
<td>Bloco / Apto: </td><td><input type=text size=12 name=slap id=slap value="<?echo $slap?>" class=styled  onKeyDown="textCounter(this.form.slap,this.form.remLen,12);" onKeyUp="textCounter(this.form.slap,this.form.remLen,12);"></td>
</tr>
...
<tr>
<td>Status: </td><td><?combo_status($status)?>
</tr>

<tr>
<td></td><td><input type=submit value="Excluir Cliente">&nbsp;<input readonly type=text name=remLen size=3 maxlength=3 value=""><b> Caracteres faltando.</td></tr>
</tr>
</table>
</FORM>
