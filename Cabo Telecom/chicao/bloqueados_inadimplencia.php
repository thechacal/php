...
$resultado=mysql_query("select id,idcabo,nome,status,ip,mac,localizacao,telefone from usuarios where status = '3' order by id");
?>
...
<p>Lista de Clientes Bloqueados por Inadimplencia</p>
