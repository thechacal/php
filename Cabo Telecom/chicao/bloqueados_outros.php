...
$resultado=mysql_query("select telefone,id,idcabo,nome,status,ip,mac,localizacao from usuarios where status = '2' order by id");
?>


   <HTML> 
<title>Lista de Clientes Bloqueados</title>
...
<br>
<p>Lista de Clientes Bloqueados por Outros Motivos</p>
...
<td width="10%"><? echo $local;?></th>
<td width="10%"><? echo $telefone;}?></th>
</tr>
</table>
<p><b>Total de Clientes Bloqueados: <?echo $bunda;?>
<hr>
