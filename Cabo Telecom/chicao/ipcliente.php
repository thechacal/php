...
?>
   ...
   <HTML> 
<title>Busca pelo IP do Cliente</title>
...
<br>
<b><p>Digite o IP do Cliente:</p></b>
<hr>

<form method="POST" action="search.php">
<p>
    <tr><td>IP:</tr></td> 
    <input type=text size=13 name=ip value="" id=ip class=styled onKeyDown="textCounter(this.form.ip,this.form.remLen,15);" onKeyUp="textCounter(this.form.ip,th    is.form.remLen,15);">
    <input type=hidden size=40 name="tipo" value="ip">
