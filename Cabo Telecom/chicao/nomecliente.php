...
?>
   ...
   <HTML> 
<title>Busca pelo Nome do Cliente</title>
...
<br>
<b><p>Digite o Nome do Cliente:</p></b>
<hr>

<form method="POST" action="search.php">
<p>
    <td><tr>Nome: </tr></td>
    <input type=text size=50 name=nome id=nome class=styled onKeyDown="textCounter(this.form.nome,this.form.remLen,45);" onKeyUp="textCounter(this.form.nome,this.form.remLen,45);">
    <input type=hidden size=50 name="tipo" value="nome">
